...
open class NodeRPCConnection(
        @Value("\${rpc.host}") private val host: String,
        @Value("\${rpc.username}") private val username: String,
        @Value("\${rpc.password}") private val password: String,
        @Value("\${rpc.port}") private val rpcPort: Int): AutoCloseable {
